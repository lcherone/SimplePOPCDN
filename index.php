...
class SimplePOPCDN 
{
    ...
    private function setup($accepted = [])
    {
        ...
        $this->cache_name = hash('sha256', $this->request);

        // set final working cache_path
    ...
    private function handle()
    {
        ...
        if (file_exists($this->cache_full)) {
            ...
            if (curl_exec($ch) !== false) {
                ...
                // Attempt to load cached file contents to serve
                if (file_exists($this->cache_full)) {
                    // Get modified time
                    $this->modified = filemtime($this->cache_full);
                    ...
                    exit(header('Location: '.$this->origin.$this->request, true, 307));
                }
            } else {
